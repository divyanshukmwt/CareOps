...
"use client";
;
const WORKSPACE_ID = "698c41f69544ffb5052a58c4"; // replace once
function InboxPage() {
    _s();
    ...
    // 1️⃣ Fetch inbox conversations
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InboxPage.useEffect": ()=>{
            fetch(`http://localhost:4000/api/inbox/${WORKSPACE_ID}`).then({
                "InboxPage.useEffect": (res)=>res.json()
            }["InboxPage.useEffect"]).then({
                "InboxPage.useEffect": (data)=>setConversations(data)
            }["InboxPage.useEffect"]).catch(console.error);
        }
    }["InboxPage.useEffect"], []);
    // 2️⃣ Fetch messages for selected conversation
    const loadMessages = (conversationId)=>{
        setSelectedConversation(conversationId);
        fetch(`http://localhost:4000/api/inbox/conversation/${conversationId}`).then((res)=>res.json()).then((data)=>setMessages(data)).catch(console.error);
    };
    // 3️⃣ Send staff reply
...
//# sourceMappingURL=_ef134760._.js.map